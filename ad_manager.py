...
class KafkaMySQLSink:
    ...
    def process_row(self, AdsInfo):
        ...
        val = (
            ...
            AdsInfo["campaign_id"],
            AdsInfo["status"],
            AdsInfo["target_gender"],
            AdsInfo["target_age_range"]["start"],
            AdsInfo["target_age_range"]["end"],
            AdsInfo["target_city"],
            AdsInfo["target_state"],
            AdsInfo["target_country"],
            AdsInfo["target_income_bucket"],
            AdsInfo["target_device"],
            AdsInfo["cpc"],
            AdsInfo["cpa"],
            AdsInfo["cpm"],
            AdsInfo["budget"],
            AdsInfo["current_slot_budget"],
            AdsInfo["date_range"]["start"],
            AdsInfo["date_range"]["end"],
            AdsInfo["time_range"]["start"],
            AdsInfo["time_range"]["end"],
            AdsInfo["text"],
            AdsInfo["category"],
            AdsInfo["keywords"],
            AdsInfo["status"],
    ...
    def process_events(self):
        ...
        # In case Kafka connection errors, restart consumer ans startprocessing
